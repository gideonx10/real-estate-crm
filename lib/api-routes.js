...
export const allowedTables = new Set(["companies", "builders", "brokers", "projects", "leads", "units", "lead_activities"]);
...
export async function listAllRecords() {
  ...
  const tableNames = ["companies", "builders", "brokers", "projects", "leads", "units", "lead_activities"];
