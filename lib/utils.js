...
export function projectMetrics(project, units = []) {
  ...
  const underNegotiation = projectUnits.filter((unit) => unit.status === "Under Negotiation").length;
...
export const statusTone = {
  ...
  "Under Negotiation": "bg-gold/10 text-gold border-gold/20",
...
export const statusButtonTone = {
  ...
  Reserved: {
    ...
    idle: "border-orange-100 bg-orange-50 text-orange-600",
